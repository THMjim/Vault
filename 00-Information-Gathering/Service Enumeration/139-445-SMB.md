...
impacket-smbclient CONTOSO/jdoe:'Pa$$word1'@10.10.10.1 -share C$ # connect
put /path/to/local/file.exe remote_file_name.exe  # upload
mput *.exe # multiple upload

nxc smb 10.10.10.1 -u jdoe -p 'Pa$$word1' --put-file /home/user/shell.exe \\C$\\Windows\\Temp\\shell.exe
```
